...
int main()
{
    //reading roll number and percentage to initialize the members while creating object
    ...
    //reading and printing student details by calling public member functions of the structure
    std.read();
    std.print();
